...
#strong[Backend & Architecture:] Microservices, MySQL, Oracle 12c, GraphQL, Node.js, Laravel, Custom CMS Development, Clean Architecture, Domain-Driven Design (DDD), Software Design.
